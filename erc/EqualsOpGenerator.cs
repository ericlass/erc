...
namespace erc
{
    class EqualsOpGenerator : IOpGenerator
    {
        public List<Operation> Generate(DataType dataType, StorageLocation target, StorageLocation operand1, StorageLocation operand2)
        {
            ...
            result.Add(new Operation(dataType, Instruction.CMOVE, StorageLocation.DataSection("imm_bool_true"), target));
            result.Add(new Operation(dataType, Instruction.CMOVNE, StorageLocation.DataSection("imm_bool_false"), target));
